...
- (void)goPlaneGo {
    ...
    [UIView animateWithDuration:5 animations:^{
       self.planeImageView.frame = CGRectMake(self.planeView.frame.size.width + 250, self.planeView.center.y - 100  , 60, 50);
...
- (void)otherWay {
    ...
    [UIView animateWithDuration:5 animations:^{
         self.planeImageView.frame = CGRectMake(self.planeView.frame.origin.x-70, self.planeView.center.y -100 , 60, 50);
